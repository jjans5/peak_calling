...
# USAGE:
# bash liftover_fragments_par.sh --i input.tsv.gz --c chain.over.chain.gz --o output.tsv.gz [--n 100000] [--tmp tmp_dir] [--ncpu 8] [--add-chr]
...
echo "🚀 Running liftOver in parallel..."
